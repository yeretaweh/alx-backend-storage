-- Task 1: Write a SQL script that creates a table `users`
...
-- 4. `country` as an enumeration of countries: US, CO, and TN, never null with default US
